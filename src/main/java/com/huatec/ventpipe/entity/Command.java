...
public class Command {
	...
	private Integer cmdid; // not null 主键
	private String cmd_datetime; // 发布命令的日期时间
	private Integer cmd_cat; // 命令大类
	private Integer cmd_subcat; // 命令小类
	private Integer cmd_state; // 命令状态(0 已处理 1 未处理)
	private String responsecode; // 应答代码(0x00:操作成功 0x01:当前设备不支持该AFN
									// 0x02:当前设备不支持该FN 0x03:数据域格式错误 0x04:存储失败
									// 0x05:无权限 0x06:忙（保留）)
	...
	private String alert_switch;
	private String alert_para; // 告警参数1
	...
	private String chooserelay; // 选择继电器
